...
public class Chatgpt extends AppCompatActivity {
    ...
    private void callAPI(String question) {
        ...
        try {
            ...
            systemMessage.put("content", "Reply shortly, directly, and begin the conversation with your personal Doctor MediTrack and remember you are here to medically assist the paitent in this MedicalApp so keep your responses like a Doctor. inquire and than suggest medcines");
